...
export const inputProfileAbout = document.querySelector('.popup__input_type_profile-job');
export const inputProfileAvatarLink = document.querySelector('.popup__input_type_link-avatar');
...
export const formChangeProfileAvatar = document.forms.changeAvatar;
export const formConfirmDel = document.forms.confirmDel;
